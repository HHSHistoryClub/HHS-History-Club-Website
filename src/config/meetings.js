...
const info = `We meet every Tuesday during lunch in room A207 (Mrs. Dinucci's room).
...
const activities = `During our meetings, we usually play history related games, presentations about historical figures, and host history bowl/bee events!`;
